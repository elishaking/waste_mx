...
class DisposeOffering{
  ...
  DisposeOffering({this.id, this.name, this.iconUrl, this.imageUrls, this.price, this.rate, this.numberOfBins, this.clientName, this.clientLocation, this.date, this.userId, this.imagePaths});
}