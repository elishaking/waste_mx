...
class _OfferingsPageState extends State<OfferingsPage>{
  ...
  List<Widget> _buildOfferings(BuildContext context){
    ...
    return List.generate(_offeringNames.length, (index) {
      ...
      return _offeringList.length > 0 ? Container() : Container(
        child: Column(
          children: <Widget>[
            ...
            Column(
              children: List.generate(_offeringList.length, (index) => Card(
                child: Container(
                      ...
                      ListTile(
                        leading: Hero(
                          ...
                          child: CircleAvatar(
                            ...
                            child: Image.asset(_offeringList[index].iconUrl),
                          ),
                        ),
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Container(
                                ...
                                child: Text('NGN ${_offeringList[index].price} for ${_offeringList[index].numberOfBins} bins at ${_offeringList[index].rate} per bin',
                                  style: TextStyle(color: Theme.of(context).primaryColor, fontWeight: FontWeight.w600),
                                ),
                              ),
                              customText.BodyText(text: _offeringList[index].clientLocation, textColor: Colors.grey,),
                              Padding(
                            ...
                            FlatButton(
                              ...
                              onPressed: (){
                                Navigator.of(context).push(MaterialPageRoute(
                                  builder: (BuildContext context) => OfferingDetails(_offeringList[index])
                                ));
                              },
                            )
                          ],
